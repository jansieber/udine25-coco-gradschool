...
% points are inserted (as ordinary points)
...
%
%% 
default={'max_nferror',1e-3,'print',1,'correc',true,'normalform',true};
...
[nunst,dom,triv,branch.point]=GetStability(branch,'funcs',funcs,pass_on{:}); %#ok<ASGLU>
fold=foldbr(branch);
