...
switch type
    case 'fold'
        tobif1=@(p)p_tofold(funcs,p,'method',branch.method.point);
    case 'hopf'
        tobif1=@(p)p_tohopf(funcs,p,'method',branch.method.point);
    otherwise        
...
[nf,nflow]=nmfm_wrap_findiff(funcs,btpoint,'BT',nmfm_compute,pass_on{:});
end