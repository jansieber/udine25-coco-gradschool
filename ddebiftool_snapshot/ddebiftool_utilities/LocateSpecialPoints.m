...
%
default={'pointtype_list',pointtype_list(),'provisional_monitor',true};
...
%% refine provisionally around detected stability changes
if options.provisional_monitor
    branch=MonitorChange(funcs,branch,pass_on{:});
end
