...
%%
function varargout=SetupStst(funcs,varargin)
%% Inputs
%
...
funcs=dde_add_cond('SetupStst',funcs,options,point);
%% correct initial guess
[br,suc]=correct_ini(funcs,br,point,dir,options.step,options.correc);
varargout=dde_setupoutput('setup',funcs,br,suc,options.outputfuncs);
end
