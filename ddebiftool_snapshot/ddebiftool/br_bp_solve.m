...
%%
default={'hdev',1e-4,'free_par',branch.parameter.free,'nulldim',2};
...
p0=branch.point(ind);
[f,u0,data]=p_correc_setup(funcs,p0,free_par,mth,'previous',p0,pass_on{:});
[ubp,suc,v0,w0,ulin]=dde_bp_solve(f,u0,@(F,X)dde_nsolve(F,X,data.method),options.hdev,...
    'nulldim',options.nulldim);
