...
%
% <html>
% $Id: hom_demo.m 176 2017-03-13 00:25:33Z jansieber $
% </html>
%
...
addpath([pwd(),'/../../ddebiftool_utilities/']);% add ddebiftool folder to path
...
Plot2dBranch({fold_branch,hopf1_branch,hopf2_branch},'ax',ax,'funcs',funcs);
...
[psol_branch,suc]=SetupPsol(funcs,hopf1_branch,27,'contpar',indp.e1,...
    'plot_measure',{@(p)p.parameter(indp.e1),@(p)p.period})
figure(2);clf;ax2=gca;
[psol_branch,s,r,f]=br_contn(funcs,psol_branch,20,'ax',ax2);
...
hcli2_br=br_contn(funcs,hcli2_br,130,'use_tangent',true,'minimal_angle',0.5);
