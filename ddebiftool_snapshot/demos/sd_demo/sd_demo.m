...
disp('stability of point 5');
disp(stbr.point(unst1).stability.l0) % stability of point 5
...
[hopfbr,s,f,r]=br_contn(funcs,hopfbr,30,'ax',ax3); % continue with plotting Hopf branch
xlabel('p2');ylabel('p9');
