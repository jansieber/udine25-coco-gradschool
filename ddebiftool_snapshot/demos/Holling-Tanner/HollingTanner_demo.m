...
%
% <html>
% $Id: HollingTanner_demo.m 176 2017-03-13 00:25:33Z jansieber $
% </html>
%%
%#ok<*UNRCH>
...
fsym=set_symfuncs(@sym_HollingTanner,'sys_tau', @()ind.tau);
...
fdir=set_funcs(...
    'sys_rhs', @HollingTanner_rhs,...
    'sys_tau', @()ind.tau,...
    'sys_dirderi',{@(x,p,dx,dp)HollingTanner_dirderi(x,p,dx,dp)},'x_vectorized',true);
