...
prob=dde_construct(prob,'psol','data',hdata(3),'tangent',true,...
    'matrix','sparse','monitors',mwplot_monitors,'excludefreqs',0);
...
prob=dde_construct(prob,'hopf','data',hdata(2),...
    'monitors',rwplot_monitors,'excludefreqs',0);
prob=add_stab(prob);
...
[~,~,~,triv_defect]=br_stabl(pdfuncs,pdbr,'pointtype_list',@rot_pointtype_list,...
