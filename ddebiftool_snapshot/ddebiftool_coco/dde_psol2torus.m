...
data.info=info;
data.pnames{trfuncs.ip.omega}='TR_rotation_number';
data.pnames{trfuncs.ip.period}='TR_period_copy';
trfuncs.ip.TR_rotation_number=trfuncs.ip.omega;
trfuncs.ip.TR_period_copy=trfuncs.ip.period;
data.funcs=trfuncs;
end
