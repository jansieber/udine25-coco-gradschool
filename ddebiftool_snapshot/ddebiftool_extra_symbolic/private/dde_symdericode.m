function [funcstr,iscollected,df,v,q]=dde_symdericode(fs,xxs,ps,funcname,varargin)
...
df=[{fs},df];
%% code generation
[funcstr,iscollected]=dde_symcode(df,xxs,ps,v,q,'funcname',funcname,varargin{:});
end