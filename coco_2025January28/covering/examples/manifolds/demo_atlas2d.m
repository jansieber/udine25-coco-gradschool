...
prob1 = coco_add_pars(prob, 'cartpar', [1 2 3], {'x' 'y' 'z'});
coco(prob1, 'torus1', [], 2, {'x' 'y' 'z'})

prob2 = coco_add_func(prob, 'angles', @angles, [], ...
  'zero', 'uidx', [1 2 3], 'u0', [pi/2; pi/2]);
prob2 = coco_add_pars(prob2, 'phipar', [4 5], {'theta' 'phi'});
coco(prob2, 'torus2', [], 2, {'theta' 'phi'})

prob3 = coco_add_func(prob, 'angles', @angles, [], ...
  'zero', 'uidx', [1 2 3], 'u0', [pi/2; pi/2]);
prob3 = coco_add_pars(prob3, 'phipar', [3 4 5], {'z' 'theta' 'phi'});
coco(prob3, 'torus3', [], 2, {'z' 'theta' 'phi'}, [0 2])
