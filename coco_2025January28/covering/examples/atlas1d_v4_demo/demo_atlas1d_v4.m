addpath ../atlas1d_v4 % Add atlas1d_v4 atlas algorithm to search path
...
coco(pprob, 'run1', [], 1, {'x' 'y'}, [1 2])

pprob = coco_set(pprob, 'cont', 'R', 0.1, 'PtMX', 30, 'indcs', 2);
coco(pprob, 'run2', [], 1, {'x' 'y'}, [1 2])
...
coco(pprob, 'run3', [], 1, {'x' 'y' 'phi'}, [1 2])

pprob = coco_set(pprob, 'cont', 'R', 0.1, 'PtMX', -30, 'indcs', [1 2]);
coco(pprob, 'run4', [], 1, {'x' 'y' 'phi'}, [1 2])

rmpath ../atlas1d_v4 % Remove atlas1d_v4 atlas algorithm from search path
...
% Gap near singular projection onto y-axis
