addpath ../atlas2d_v4 % Add atlas2d_v3 atlas algorithm to search path
...
pprob = coco_set(pprob, 'cont', 'R', 0.4, 'PtMX', 500, ...
...
rmpath ../atlas2d_v4 % Remove atlas2d_v4 atlas algorithm from search path
